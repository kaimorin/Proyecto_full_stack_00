...
public class LeccionarioController {
    ...
    // * Método Listar todos los leccionarios * //
    ...
    // * Método Buscar leccionario por ID * //
    ...
    // * Método Crear nuevo leccionario * //
    @PostMapping("/crear")
    ...
    // * Método Actualizar leccionario específico * //
    @PutMapping("/{id}")
    ...
    // * Método Eliminar leccionario por ID * //
